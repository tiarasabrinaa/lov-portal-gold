...
class EmployerAccountRead(BaseModel):
    ...
    branch_address_detail: str | None = None
    branch_address_village_district: str | None = None
    branch_address_city: str | None = None
    branch_address_province: str | None = None
